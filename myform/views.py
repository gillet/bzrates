...
class MutForm(forms.Form):
    N0 = forms.IntegerField(help_text="Initial number of cells in the culture", initial=1, label="N0", widget=forms.NumberInput(attrs={'class': 'narrow-select', 'required': "", 'min': 1e0}))
